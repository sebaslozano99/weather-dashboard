...
export default function DeleteWeatherBtn({id}) {
 ...
 const queryClient = useQueryClient()
  ...
  return (
    <button 
      className="absolute z-10 top-2 right-2 flex justify-center items-center text-white/80 hover:text-white w-6 h-6 bg-[#21295C]/30 dark:bg-white/20 hover:bg-[#21295C]/60 dark:hover:bg-white/40 transition-all duration-300 ease-in-out rounded-full" 
