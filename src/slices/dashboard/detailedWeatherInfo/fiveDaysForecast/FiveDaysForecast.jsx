...
export default function FiveDaysForecast({position}) {
  ...
  if(isPending) return <div className="flex justify-center items-center col-span-8 row-span-4 rounded-lg bg-white/20 dark:bg-[#252525]/60 shadow-2xl" >
    <Spinner size={7} />
  </div>
  ...
  return (
    <div className="col-span-10 row-span-8 flex flex-col gap-4 p-4 bg-white/20 dark:bg-[#252525]/60 rounded-lg shadow-2xl" >
