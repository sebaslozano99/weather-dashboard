...
export default function NavBarMobile({showMenu, setShowMenu}) {
  return (
    <nav className={`fixed top-[10vh] ${showMenu ? "right-0" : "right-[-100%]"} min-[580px]:hidden z-50 h-[90vh] flex justify-center items-center w-full bg-[#21295C] transition-all duration-500 ease-in-out`} >
